...
{
    const PLUGIN_CALENDAR_MODEL_GET_CALENDARS = 'Qobo/Calendar.Model.getCalendars';
    const PLUGIN_CALENDAR_MODEL_GET_EVENTS = 'Qobo/Calendar.Model.getCalendarEvents';
